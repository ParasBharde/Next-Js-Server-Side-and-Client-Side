  ...
  return (
    ...
    <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
            <div>
                ...
                <div className="pt-2">
                    <LabelledInput label="Username" placeholder="paras@gmail.com" />
                    ...
                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Already have an account? <Link href="signup" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Signup here</Link>
                  </p>
                </div>
            </div>
        </a>
